  ...
  <div id="CreatePost" class="fixed z-50 bottom-0 h-full w-full overflow-hidden">
    ...
    <div class="bg-black h-full w-full text-white overflow-auto">
        ...
        <div class="py-2 w-full">
          ...
          <div class="flex items-center">
            <div class="flex items-center text-white">
              ...
              <div class="ml-2 font-semibold text-[18px]">Diary Budi</div>
            </div>
          </div>
            ...
            <div class="bg-black rounded-lg w-[calc(100%-50px)] font-light">
              ...
              <div class="w-full">
                <div class="flex flex-col gap-2 py-1">
                  ...
                  <label for="fileInput">
                    <Icon name="clarity:paperclip-line" size="25" color="#fffff"/> 
                    <input 
                      type="file"
                      ref="file"
                      id="fileInput"
      ...
      <button
        ...
        :disabled="isLoading"
        @click="createPost"
        class="fixed bottom-0 font-bold text-lg w-full p-2 bg-black inline-block float-right border-t border-gray-700"
